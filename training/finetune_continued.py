"""
HAYA Training Script — Continued Fine-Tuning
"""
import os
import sys
import json
...
# Config
# ============================================================
MODEL_NAME = "training/best_model"
MAX_LENGTH = 128
EPOCHS = 3
BATCH_SIZE = 16
...
TRAIN_PATH = "data/splits/new_train.parquet"
VAL_PATH = "data/splits/new_val.parquet"
OUTPUT_DIR = "training/checkpoints_v2"
BEST_MODEL_DIR = "training/best_model_v2"
LOG_DIR = "training/logs_v2"
...
def main():
    ...
    print("=" * 60)
    print("HAYA Training — Continued Fine-tuning")
    ...
    weight_toxic = safe_count / max(toxic_count, 1)
    ...
    print("\n[2/6] Loading MARBERT (Best Model)...")
